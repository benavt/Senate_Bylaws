...
\SSArticle{ss-article-1}{Article I: Organization}
...
\SSArticle{ss-article-2}{Article II: Memberships}
...
\SSArticle{ss-article-3}{Article III: Officers}
...
\item The Grand Marshal assumes the duties of any unfilled officer position, with the exception of committee chairs, which the Vice Grand Marshal shall assume the duties of. Neither the Grand Marshal nor the Vice Grand Marshal shall assume the duties of the Elections Commissioner.
  \begin{enumerate}
...
\item The Treasurer shall be responsible for:
  ...
  \item Preparing the annual budget of the Student Senate, subject to the approval of the Grand Marshal; and
    \begin{enumerate}
    \item The Grand Marshal or Vice Grand Marshal must be present at the final budget meeting with the treasurer and the Executive Board Club Representative for the Student Senate.
    \end{enumerate}
...
\SSArticle{ss-article-4}{Article IV: Duties of Office}
...
\SSArticle{ss-article-5}{Article V: Meetings}
...
\SSArticle{ss-article-6}{Article VI: Legislation}
...
\SSArticle{ss-article-7}{Article VII: Rules for Voting and Debate}
...
\item Upon entering debate, a queue will be established and maintained by the Parliamentarian.
  ...
  \item b. Discussion on any given motion shall be limited to 45 minutes. After which, the queue for discussion on the motion will be closed.
    \begin{enumerate}
...
\SSArticle{ss-article-8}{Article VIII: Removals}
...
\SSArticle{ss-article-9}{Article IX: Committees}
...
\item The Elections Commission:
  ...
  \item Its duties shall include the following:
    \begin{enumerate}
    \item The Committee shall be responsible for reviewing and approving the language of all constitutional amendments that come before the Senate for approval.
...
\item The Senate Communications and Engagement Committee, hereby referred to as the SCEC, shall be responsible for promoting the initiatives and activities of the Student Senate.
  ...
  \item It shall promote cohesion between the Senate and other Union bodies.
    \begin{enumerate}
    \item It shall be the responsibility of the chairpersons, or designated representative, of each Student Senate committee to correspond with both the SCEC chairperson and the Vice Grand Marshal on all publicity information.
...
\SSArticle{ss-article-10}{Article X: Petitions}
...
\item Petitions shall be a means by which members of the Union may bring concerns, initiatives, or ideas before the Student Senate.
  ...
  \item Petitions may only be created and signed by members of the Union.
    ...
    \end{enumerate}
  \item The Elections Commission shall maintain rules governing the petition process.
    \begin{enumerate}
...
\SSArticle{ss-article-11}{Article XI: Appointments}
...
\SSArticle{ss-article-12}{Article XII: Amendments}
...
\SSArticle{ss-article-13}{Article XIII: Succession}
...
\SSArticle{ss-article-14}{Article XIV: Inquiries}
...
\item An investigatory committee, standing committee charged with conducting an inquiry, or individual tasked with conducting an inquiry shall be empowered, in pursuance to the objectives of the inquiry assigned to them by the Senate:
  ...
  \item To gather testimony, documents, or comments from individuals or bodies relevant to the inquiry.
    ...
    \end{enumerate}
  \item To compel the provision of documents belonging to the Union, which includes but is not limited to Bylaws, meeting minutes, committee records, and attendance records, in such cases where an individual or body does not comply with a request for such documents pursuant to subclause (ii).
    \begin{enumerate}
